...
public class HuffmanCode {
  public static void main(String[] args) {
    ...
    String[] codes = getCodes(tree.root); // Get codes
  ...
  /* Recursively get codes to the leaf nodes */
  ...
  public static class Tree implements Comparable<Tree> {
    ...
    public int compareTo(Tree t) {
      return t.root.weight - this.root.weight; // The tree with the lesser weight is greater.
